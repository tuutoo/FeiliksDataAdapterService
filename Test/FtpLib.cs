...
namespace Test
{
    public class FtpWeb 
    {
        ...
        public void Download(string filePath, string fileName)
        {
            ...
            {
                WriteLog("FtpWeb:Download Error --> "+ ex.Message);
        ...
        public void Delete(string fileName)
        {
            ...
            {
                WriteLog("FtpWeb:Delete Error --> " + ex.Message + "  文件名:" + fileName);
        ...
        public void RemoveDirectory(string folderName)
        {
            ...
            {
                WriteLog("FtpWeb:Delete Error --> " + ex.Message + "  文件名:" + folderName);
        ...
        public string[] GetFilesDetailList()
        {
            ...
            catch (Exception ex)
            {
                ...
                WriteLog("FtpWeb:GetFilesDetailList Error --> " + ex.Message );
        ...
        public string[] GetFileList(string mask)
        {
            ...
            catch (Exception ex)
            {
                ...
                //{
                WriteLog("FtpWeb:GetFileList Error --> " + ex.Message );
        ...
        public void MakeDir(string dirName)
        {
            ...
            {
                WriteLog("FtpWeb:MakeDir Error --> " + ex.Message);
        ...
        public long GetFileSize(string filename)
        {
            ...
            {
                WriteLog("FtpWeb:GetFileSize Error --> " + ex.Message);
        ...
        public void ReName(string currentFilename, string newFilename)
        {
            ...
            {
                WriteLog("FtpWeb:ReName Error --> " + ex.Message);
